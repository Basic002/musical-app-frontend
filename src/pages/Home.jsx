    ...
    <div className="h-screen w-full flex flex-col bg-night-bg font-body text-white overflow-hidden">
      ...
      <header className="h-20 border-b border-night-card flex items-center justify-between px-6 bg-night-bg relative z-20">
        ...
        <div className="flex items-center gap-4">
          <Link
            to="/login"
            className="text-night-text hover:text-white font-medium transition-colors hidden sm:block"
          >
            Connexion
          </Link>
          <Link
            to="/register"
            className="bg-neon-violet hover:bg-purple-500 text-white px-6 py-2 rounded-full font-medium transition-all shadow-[0_0_15px_rgba(139,92,246,0.3)] hover:shadow-[0_0_20px_rgba(139,92,246,0.5)]"
          >
            S'inscrire
          </Link>
        </div>
      ...
      <main className="flex-1 relative bg-night-bg p-4 flex">
        ...
        <div className="w-full h-full bg-night-card/50 rounded-2xl border-2 border-dashed border-slate-700 flex flex-col items-center justify-center relative overflow-hidden">
          {/* Icône de carte */}
          <svg
            className="w-20 h-20 text-slate-600 mb-4"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <h2 className="text-3xl font-title font-bold text-slate-500 mb-2">
            Zone de la Carte
          </h2>
