    ...
    <div className="min-h-screen bg-night-bg font-body text-white pb-10 relative">
      ...
      <header className="h-20 border-b border-slate-800 flex items-center justify-between px-6 bg-night-card sticky top-0 z-20 shadow-md">
        <div className="flex items-center gap-4">
          <Link to="/" className="text-2xl font-title font-bold tracking-wide hover:opacity-80 transition-opacity">
        ...
        <nav className="flex items-center gap-4">
          <Link to="/admin" className="text-night-text hover:text-white transition-colors text-sm font-medium flex items-center gap-2">
      ...
      <main className="max-w-4xl mx-auto px-4 mt-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-title font-bold text-white mb-2">Créer un événement</h1>
          <p className="text-night-text">Remplissez les informations ci-dessous pour ajouter un nouveau concert à la carte.</p>
        </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-night-text mb-1.5">Affiche du concert *</label>
                ...
                >
                  ...
                  {!imagePreview ? (
                    <>
                      <svg className="w-12 h-12 text-slate-600 mb-3 group-hover:text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 00-2 2z"></path>
                      </svg>
                      <p className="text-slate-500 font-medium text-sm">
                        Glissez une affiche ici <span className="text-slate-600">(PNG, JPG)</span>
                      </p>
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-night-text mb-1">Nom de l'artiste ou de l'événement *</label>
                <input 
                  type="text" 
              ...
              {/* Date */}
              <div>
                <label className="block text-sm font-medium text-night-text mb-1">Date *</label>
                <input 
                  type="date" 
              ...
              {/* Heure */}
              <div>
                <label className="block text-sm font-medium text-night-text mb-1">Heure (Ouverture des portes)</label>
                <input 
                  type="time" 
                  className="w-full bg-night-bg border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-neon-cyan transition-colors [color-scheme:dark]"
                />
              ...
              {/* Salle / Lieu */}
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-night-text mb-1">Lieu / Salle *</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-sm font-medium text-night-text mb-1">Latitude (GPS)</label>
                <input 
                  type="text" 
                  placeholder="48.8702"
              ...
              <div>
                <label className="block text-sm font-medium text-night-text mb-1">Longitude (GPS)</label>
                <input 
                  type="text" 
                  placeholder="2.3283"
                  className="w-full bg-night-bg border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-neon-violet transition-colors placeholder-slate-600"
              ...
              {/* Description */}
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-night-text mb-1">Description</label>
                <textarea 
                  rows="4"
