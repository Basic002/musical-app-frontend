    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-night-bg font-body p-4 relative">
      ...
      <div className="w-full max-w-md bg-night-card rounded-2xl shadow-2xl p-8 border border-slate-800">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-title font-bold text-white mb-2">Bon retour !</h1>
          <p className="text-night-text">Connectez-vous pour retrouver vos favoris.</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <div>
            <label className="block text-sm font-medium text-night-text mb-1">Mot de passe*</label>
            <input
              type="password"
              value={password}
        ...
        <div className="mt-6 text-center text-night-text text-sm">
          ...
          <Link to="/register" className="text-neon-cyan hover:underline font-medium">S'inscrire</Link>
        </div>
      </div>
    </div>
  );
